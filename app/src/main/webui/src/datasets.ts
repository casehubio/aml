...
// When the endpoint exists, replace with: dataset("work-items", "/api/work-items?status=OPEN&scope=casehubio/aml")
...
// Metrics
export const throughputDataset = dataset("throughput", "/api/metrics/throughput");
export const trustScoresDataset = dataset("trust-scores", "/api/metrics/trust-scores", {
  dataPath: "scores",
});
export const gateMetricsDataset = dataset("gate-metrics", "/api/metrics/gates");
